...
# def unet(pretrained_weights = None, input_size = input_size, classNum = 2, learning_rate = learning_rate):
def unet(pretrained_weights = None, input_size = (512, 512, 3), classNum = 2, learning_rate = 1e-5):
    ...
    #  用于配置训练模型（优化器、目标函数、模型评估标准）  # Adam改为adam_v2.Adam
