from _3_seg_unet import unet
# from Model.seg_hrnet import seg_hrnet
from _2_dataProcess import trainGenerator, color_dict
...
train_image_path = "F:\Files auto-update\\0 Graduation Paper\\2Model\Database\\0UnetTrainData\\train_img"
#  训练数据标签路径
# train_label_path = "Data\\train\\label"
train_label_path = "F:\Files auto-update\\0 Graduation Paper\\2Model\Database\\0UnetTrainData\\train_label"
#  验证数据图像路径
# validation_image_path = "Data\\validation\\image"
validation_image_path = "F:\Files auto-update\\0 Graduation Paper\\2Model\Database\\0UnetTrainData\\val_img"
#  验证数据标签路径
# validation_label_path = "Data\\validation\\label"
validation_label_path = "F:\Files auto-update\\0 Graduation Paper\\2Model\Database\\0UnetTrainData\\val_label"
'''
模型相关参数
'''
#  批大小
...
premodel_path = None
#  训练模型保存地址
model_path = "F:\Files auto-update\\0 Graduation Paper\\2Model\Database\\0UnetTrainData\model_save"
